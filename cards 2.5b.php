	<?php
	// TO DO
	// - Add save button? Use timestmap.
	//   Will this need to reload ever, how if yes?
	//   (Possibly later, never have needed this.)
...
<html>
	<head>
		<title>Card Sorter v2.5b</title>
		<link rel="stylesheet" type="text/css" href="style.css">
	</head>
	<body id="TBody">
		<table cellpadding="15" width="100%">
			<form action="cards 2.5b.php" method="post">
